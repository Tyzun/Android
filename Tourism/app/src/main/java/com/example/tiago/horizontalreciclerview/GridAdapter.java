...
public class GridAdapter extends BaseAdapter {
    ...
    public View getView(int i, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            TextView textViewAndroid = (TextView) gridViewAndroid.findViewById(R.id.gridViewText);
            ImageView imageViewAndroid = (ImageView) gridViewAndroid.findViewById(R.id.gridViewImage);
